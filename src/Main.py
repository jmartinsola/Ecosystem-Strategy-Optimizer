''' A Pyomo-Gurobi model for the PAT Rich Portfolio Opt. Problem (c) Angel A. Juan 2023.24.12 '''
...
instance = '5'  # select instance between 1 and 5 for the port1 to port5 txt files
